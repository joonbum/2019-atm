...
data.aoi$condition_name[(data.aoi$frame>94686)&(data.aoi$frame<103000)]<-condition.table[[1,"condition_name"]]
data.aoi$condition_name[(data.aoi$frame>87162)&(data.aoi$frame<94685)]<-condition.table[[2,"condition_name"]]
data.aoi$condition_name[(data.aoi$frame>103000)&(data.aoi$frame<112780)]<-condition.table[[3,"condition_name"]]
data.aoi$condition_name[(data.aoi$frame>120060)&(data.aoi$frame<129350)]<-condition.table[[4,"condition_name"]]
